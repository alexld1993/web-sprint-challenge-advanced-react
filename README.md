...
1. What are the main differences between a stateful and a functional component?
   The difference is that one has state. stateful components are keeping track of changing data. Functional components print out what is given to them via props, or they always render the same thing. A stateless component is written as a function.

2. When does a componentWillMount function be called? What about a componentWillUpdate?
   componentWillMount updates immediately even before the render method is called. componentWillUpdate is called before rendering and changes with new props or state.

3. Define stateful logic.
   State describes the current condition of the UI. It can be shared between components and some of them can perform changes on it.
